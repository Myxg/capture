...
# s = time.localtime(tt)
# t = str(s.tm_year) + str(s.tm_mon).zfill(2) + str(s.tm_mday) + str(s.tm_hour).zfill(2) + str(s.tm_min).zfill(2)
# now_time = t.ljust(17, '0')
# print(now_time)
# print(distance_a1,average_a1,max_speed_a1,distribute_a1)
...
for count_num in range(1, 9):
    ...
    cursor = db.cursor()
    sql = 'select frame_num,people_num,x,y from zb' + str(count_num) + ' where frame_num<"44000" and frame_num > "20000"'
    cursor.execute(sql)
    ...
    fb = [{'name': 'a1', 'data': distribute_a1}, {'name': 'a2', 'data': distribute_a1}, {'name': 'b1', 'data': distribute_a1},{'name': 'b2', 'data': distribute_a1}]
    ...
    # print(distance_a1,average_a1,max_speed_a1,distribute_a1)
    # # print(coordinate_a2)
    # print(distance_a2,average_a2,max_speed_a2,distribute_a2)
    # # print(coordinate_b1)
    # print(distance_b1,average_b1,max_speed_b1,distribute_b1)
    # # print(coordinate_b2)
    # print(distance_b2,average_b2,max_speed_b2,distribute_b2)
print(data)
